...
<aside class="bg-light border-end vh-100 position-fixed shadow-sm d-flex flex-column"
    style="width: 250px; top: 0; left: 0; z-index: 999;">
    ...
    <div class="overflow-auto p-3">
        ...
        <ul class="nav nav-pills flex-column">
            <li class="nav-item mb-1">
                <a href="/TCC/inicio.php"
                    class="nav-link <?php echo ($active_page == 'inicio.php') ? 'active' : 'text-dark'; ?>">
            ...
            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'gerente', 'qualidade', 'rh', 'manutencao', 'estoque'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/indicadores/index.php"
                        class="nav-link <?php echo ($active_section == 'indicadores') ? 'active' : 'text-dark'; ?>">
            ...
            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'gerente', 'rh'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/rh/index.php"
                        class="nav-link <?php echo ($active_section == 'rh') ? 'active' : 'text-dark'; ?>">
            ...
            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'gerente', 'qualidade'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/qualidade/index.php"
                        class="nav-link <?php echo ($active_section == 'qualidade') ? 'active' : 'text-dark'; ?>">
                        <i class="bi bi-check-circle-fill me-2"></i>Qualidade
                    </a>
                </li>
            <?php } ?>

            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'fiscal'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/fiscal/index.php"
                        class="nav-link <?php echo ($active_section == 'fiscal') ? 'active' : 'text-dark'; ?>">
                        <i class="bi bi-newspaper me-2"></i>Fiscal
                    </a>
                </li>
            <?php } ?>

            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'compras'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/compras/index.php"
                        class="nav-link <?php echo ($active_section == 'compras') ? 'active' : 'text-dark'; ?>">
                        <i class="bi bi-newspaper me-2"></i>Compras
                    </a>
                </li>
            <?php } ?>
            ...
            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'gerente', 'estoque'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/estoque/index.php"
                        class="nav-link <?php echo ($active_section == 'estoque') ? 'active' : 'text-dark'; ?>">
            ...
            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'gerente', 'manutencao'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/manutencao/index.php"
                        class="nav-link <?php echo ($active_section == 'manutencao') ? 'active' : 'text-dark'; ?>">
            ...
            <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'gerente', 'qualidade', 'rh', 'manutencao', 'estoque'])) { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/documentacoes/index.php"
                        class="nav-link <?php echo ($active_section == 'documentacoes') ? 'active' : 'text-dark'; ?>">
            ...
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') { ?>
                <li class="nav-item mb-1">
                    <a href="/TCC/pages/configuracoes/index.php"
                        class="nav-link <?php echo ($active_section == 'configuracoes') ? 'active' : 'text-dark'; ?>">
