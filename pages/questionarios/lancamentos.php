...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST["escolheu_btn"])) {
        ...
        if ($id_do_questionario != "-") {
            ...
            $mensagem = "<div class='alert alert-warning'>
                Por favor, selecione um questionário antes de continuar.
            </div>";
        }
    }
    ...
    if (isset($_POST['lancar_btn'])) {
        ...
        if ($id_do_questionario == "-" || empty($id_do_questionario)) {
            ...
            $mensagem = "<div class='alert alert-warning'>
                Selecione um questionário válido antes de enviar.
            </div>";
            ...
            try {
                ...
                foreach ($_POST as $campo_id => $valor) {
                    ...
                    if (strpos($campo_id, 'campo_') === 0) {
                        ...
                        // CHECKBOX retorna array
                        if (is_array($valor)) {

                            $valor_resposta = json_encode(
                                $valor,
                        ...
                        $valor_resposta = htmlspecialchars(
                            $valor_resposta,
                            ENT_QUOTES,
                            'UTF-8'
                        );
                ...
                $mensagem = "<div class='alert alert-success'>
                    ...
                    ID do Lançamento: $id_lancamento
                </div>";
...
<div class="main-content p-5" style="margin-left: 250px;">
            ...
            >
                ...
                <?php if (empty($questionarios)): ?>
                    ...
                    <option value="-" disabled>
                        Nenhum questionário disponível para você.
                    </option>
                ...
                <?php else: ?>
                    ...
                    <?php foreach ($questionarios as $questionario): ?>
                        ...
                        <option
                            value="<?= $questionario['id_questionario'] ?>"
    ...
    <div
        id="divDasPerguntas"
        class="container"
        style="display: <?= $abrir_div_perguntas ?>;"
    >
        ...
        <form method="post">
            ...
            <input
                type="hidden"
                name="questionario"
                value="<?= htmlspecialchars($id_do_questionario) ?>"
            />
                            ...
                            echo '
                                <div class="form-floating mb-3">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        id="campo_' . $id_campo . '"
                                        name="campo_' . $id_campo . '"
                                        required
                                    >

                                    <label for="campo_' . $id_campo . '">
                                        ' . $nome_campo . '
                                    </label>
                        ...
                        elseif ($tipo_c == "CHECKBOX") {
                            ...
                            if (is_array($opcoes)) {
                                ...
                                foreach ($opcoes as $index => $opcao) {
                                    ...
                                    $checkbox_id = 'campo_' . $id_campo . '_' . $index;
