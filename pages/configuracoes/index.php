...
<head>
    ...
    <title>Configurações - La Vita Andradas</title>
    ...
    <div class="main-content" style="margin-left: 250px; margin-top: 70px; padding: 20px;">
        <div class="content-wrapper">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <p class="card-text">Esta seção está em desenvolvimento. Em breve, você poderá gerenciar as configurações do sistema.</p>
                </div>
            </div>
        </div>
    </div>
